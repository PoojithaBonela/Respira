          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                />
                {/* Dark gradient overlay - 45% height */}
                <div style={{
                  position: 'absolute',
                  bottom: 0,
                  left: 0,
                  right: 0,
                  height: '45%',
                  background: 'linear-gradient(to top, rgba(0, 20, 10, 0.95) 0%, rgba(0, 30, 15, 0.85) 30%, rgba(0, 40, 20, 0.75) 60%, transparent 100%)',
                  pointerEvents: 'none'
                }} />
                {/* Text overlay */}
                <div style={{
                  ...
                  <p style={{
                    ...
                    You're already ahead of millions of smokers.
                  </p>
                  <p style={{
                    color: '#d1d5db',
                    fontSize: '13px',
                    ...
                    You chose awareness over avoidance. Smoking is present, but controlled — no guilt, no fear.
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Every cigarette you log matters.
                  </p>
                  <p style={{
                    color: '#d1d5db',
                    fontSize: '13px',
                    ...
                    Awareness is the first step to control. Logging builds progress visually — without pressure to quit.
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    What feels random reveals structure. AI-driven insights connect smoking habits with daily life.
                  </p>
                </div>
              </div>
            </div>
